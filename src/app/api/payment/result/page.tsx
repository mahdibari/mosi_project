...
// کامپوننتی که منطق اصلی و استفاده از searchParams در آن قرار دارد
  ...
  if (status === 'loading') {
    return (
      <div className="flex flex-col items-center justify-center min-h-[40vh]">
        <Loader2 className="w-20 h-20 text-indigo-500 animate-spin mb-6" />
...
// کامپوننت اصلی صفحه که Suspense را مدیریت می‌کند
    ...
    <main className="container mx-auto px-4 py-16 min-h-[60vh] flex flex-col items-center justify-center">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 max-w-md w-full text-center">
        <Suspense fallback={
          <div className="flex flex-col items-center justify-center min-h-[40vh]">
            <Loader2 className="w-20 h-20 text-indigo-500 animate-spin mb-6" />
            <p className="text-gray-500">در حال آماده‌سازی...</p>
          </div>
        }>
          <PaymentContent />
        </Suspense>
